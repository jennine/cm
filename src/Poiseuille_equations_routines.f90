  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_DYNAMIC_POISEUILLE_SUBTYPE)
        CALL POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_CONTINUITY_POISEUILLE_SUBTYPE)
        CALL POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*999)
      CASE DEFAULT
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_CONTINUITY_POISEUILLE_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_FLUID_MECHANICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_POISEUILLE_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_CONTINUITY_POISEUILLE_SUBTYPE
      CASE DEFAULT
...
999 CALL ERRORS("POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: component_idx,GEOMETRIC_COMPONENT_NUMBER,GEOMETRIC_SCALING_TYPE,NUMBER_OF_DIMENSIONS, &
      ...
      & SOURCE_FIELD_NUMBER_OF_VARIABLES,Ncompartments
    TYPE(DECOMPOSITION_TYPE), POINTER :: GEOMETRIC_DECOMPOSITION,DECOMPOSITION
    ...
    TYPE(FIELD_TYPE), POINTER :: INDEPENDENT_FIELD,MATERIAL_FIELD,EQUATIONS_SET_FIELD_FIELD 
    TYPE(VARYING_STRING) :: LOCAL_ERROR   
        ...
        CASE(EQUATIONS_SET_SETUP_DEPENDENT_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN              
                write(*,*)'The dependent field is auto-created'
              ...
              CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,1, &
                & ERR,ERROR,*999)
              CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_DELVDELN_VARIABLE_TYPE,1, &
                & ERR,ERROR,*999)
              ...
              END SELECT
            ELSE
              write(*,*)'the dependent field is user specified'
        ...
        CASE(EQUATIONS_SET_SETUP_EQUATIONS_TYPE)
 		 ...
 		 EQUATIONS_EQUATIONS_SET_FIELD=>EQUATIONS_SET%EQUATIONS_SET_FIELD
                ...
                CALL FIELD_DIMENSION_SET_AND_LOCK(EQUATIONS_EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_VECTOR_DIMENSION_TYPE,ERR,ERROR,*999)
                CALL FIELD_DIMENSION_SET_AND_LOCK(EQUATIONS_EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                  & FIELD_VECTOR_DIMENSION_TYPE,ERR,ERROR,*999)
                ...
                CALL FIELD_DATA_TYPE_SET_AND_LOCK(EQUATIONS_EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                  & FIELD_INTG_TYPE,ERR,ERROR,*999)
                 ! the decomposition will have to be of mixed element and node based type is this possible ?
               ! CALL FIELD_MESH_DECOMPOSITION_GET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,DECOMPOSITION,ERR,ERROR,*999)
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
             ...
             !cannot finish the equations set field because it thinks it doesn't ahve a mesh decomposition see line 726
            SELECT CASE(EQUATIONS_SET%SOLUTION_METHOD)
            CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
              ...
              EQUATIONS_SET_FIELD_FIELD=>EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD !field is not associated
              write(*,*)'Equations set field doesnt object'
              ...
              write(*,*)'N Compartment=',NCompartments
              !if I can find Ncompartments can send one matrix to Equations mapping which is what I want to do not send two, cant do this till I can finish the  
              !equations set field line 737 
              ...
              !Now what I need to do here is to figure out how many RHS equations there should be
